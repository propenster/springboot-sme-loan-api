package com.github.propenster.SmeLoanGiver.Authentication.Payloads.Response;
...
public class JwtResponse {
    ...
    public JwtResponse(String accessToken, String id, String username, String email, List<String> roles, NewSMEAccountRequest sme_account) {
